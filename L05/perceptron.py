...
class simple_perceptron:
    ...
    def train(self, Xtrain, Ytrain, Xvalid, Yvalid):
        ...
        for epoch in range(self.epochs):
            ...
            for i in range(len(Xtrain)):
                ...
                for j in range(self.Nin):
                    self.weights[j] += self.learning_rate * Yout * (Ytrain[i] - sumWeighted) * Xtrain[i][j]
    ...
    def save_model(self, filename):
        ...
        model_params = {
            ...
            "Nin": self.Nin,
            "min_val": self.min_val if hasattr(self, 'min_val') else None,
            "max_val": self.max_val if hasattr(self, 'max_val') else None
        }
    ...
    def load_model(self, filename):
        ...
        self.Nin = model_params["Nin"]
        self.min_val = model_params["min_val"] if "min_val" in model_params else None
        self.max_val = model_params["max_val"] if "max_val" in model_params else None
